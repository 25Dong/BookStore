...
<body>
	<div id="header">
		<s:if test="#session.username!=null">
			<div id="userdiv">
				...
				<i class="fa fa-bank"></i>企业采购&nbsp;&nbsp;
				<i class="fa fa-user-o"></i>客户服务&nbsp;&nbsp;
 ...
 --%>
		...
		<div class="contWidth">
			...
			<!--搜索框  -->
			<div class="search">
				<form action="FindLikeBK_Book.action" method="post">
					<input type="text" id="inputSearch" class="" value="请输入书本名称"
						name="book.name" /> <i class="fa fa-search"></i>&nbsp;<input
