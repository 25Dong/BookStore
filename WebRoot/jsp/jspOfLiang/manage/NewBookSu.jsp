...
<meta http-equiv="refresh" content ="4;url=<%=request.getContextPath()%>/manager_NewBook.action">
<link rel="stylesheet"
...
var i = 5; function shownum(){ 
i=i-1; document.getElementById("time").innerHTML=i+"秒后自动跳转到添加图书页面";
...
<body onload="shownum()">
	...
	<div class="container">
		...
		<div class="col-md-12">
			<span id="time"></span>
			<p>
				若跳转失败请<a href="<%=request.getContextPath()%>/manager_NewBook.action">点击这里！</a>
			</p>
			<p>
				若要查看上传后的所有图书信息<a href="<%=request.getContextPath()%>/manager_AllBook.action">点击这里！</a>
			</p>
		</div>
	</div>
